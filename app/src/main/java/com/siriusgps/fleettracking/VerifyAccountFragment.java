 ...
 * {@link VerifyAccountFragment.OnFragmentInteractionListener} interface
...
public class VerifyAccountFragment extends Fragment {
    ...
    private OnVerifyAccountInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSubmitVerification();
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        Log.d(TAG, "onAttach()");
        try {
            mListener = (OnVerifyAccountInteractionListener) activity;
     ...
     */
    public interface OnVerifyAccountInteractionListener {
